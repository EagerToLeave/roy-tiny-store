/*
 ...
 Source Schema         : roy-mall

 Target Server Type    : MySQL
 Target Server Version : 80026
 File Encoding         : 65001

 Date: 13/10/2021 16:52:45
*/
...
CREATE TABLE `pms_comment`  (
  ...
  `create_time` datetime NULL DEFAULT NULL,
  `show_status` int NULL DEFAULT NULL COMMENT '0->显示，1->隐藏',
...
CREATE TABLE `sms_flash_promotion`  (
  ...
  `status` int NULL DEFAULT NULL COMMENT '上下线状态,1上线、0下线',
...
CREATE TABLE `sms_flash_promotion_product_relation`  (
  ...
  `flash_promotion_id` bigint NULL DEFAULT NULL COMMENT '秒杀活动ID->关联sms_flash_promotion表',
  `flash_promotion_session_id` bigint NULL DEFAULT NULL COMMENT '当前日期活动场次编号',
...
CREATE TABLE `sms_home_brand`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `brand_id` bigint NULL DEFAULT NULL COMMENT '品牌ID[关联pms_brand品牌推荐]',
  `brand_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '品牌名称',
  `recommend_status` int NULL DEFAULT NULL COMMENT '推荐状态:1推荐，0取消推荐',
